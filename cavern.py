...
class Player(GravityActor):
    ...
    def update(self, input_state=None):
        ...
        if self.hurt_timer > 100:
            ...
            if input_state and input_state.fire_pressed and self.fire_timer <= 0:
...
def draw_status(screen, game):
    ...
    draw_text(s, 451, WIDTH - 2 - (number_width * len(s)), screen)

    # Display level number
    draw_text("LEVEL " + str(game.level + 1), 451, None, screen)
